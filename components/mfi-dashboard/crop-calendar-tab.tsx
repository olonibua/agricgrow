          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-sm flex items-start gap-2">
                <span className="text-primary mt-1">•</span>
                <span>
                  Consider the farmer&apos;s experience with ${selectedCrop}{" "}
                  cultivation and their historical yields.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-sm flex items-start gap-2">
                <span className="text-primary mt-1">•</span>
                <span>
                  Repayment grace period: Allow {cropInfo?.durationDays / 30}{" "}
                  months grace period to align with the crop's maturity
                  timeline.
                </span>
              </li>
              <li className="text-sm flex items-start gap-2">
                <span className="text-primary mt-1">•</span>
                <span>
                  Loan term: For {selectedCrop}, a term of{" "}
                  {Math.ceil(cropInfo?.durationDays / 30) + 2} to{" "}
                  {Math.ceil(cropInfo?.durationDays / 30) + 4} months is
